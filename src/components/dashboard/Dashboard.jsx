...
export default function Dashboard() {
  ...
  const updatedStats = {
    ...
    totalGainLoss: stocks.reduce(
      (sum, stock) => sum + stock.change * stock.shares,
      0
    ),
    dayGainLoss: stocks.reduce(
      (sum, stock) => sum + stock.change * stock.shares,
      0
    ),
  };
  updatedStats.totalGainLossPercent =
    (updatedStats.totalGainLoss /
      (updatedStats.totalValue - updatedStats.totalGainLoss)) *
    100;
  updatedStats.dayGainLossPercent =
    (updatedStats.dayGainLoss / updatedStats.totalValue) * 100;
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-indigo-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 transition-colors duration-500">
      ...
      <div
        className={`fixed top-0 left-0 h-full w-80 max-w-[85vw] bg-white dark:bg-gray-800 shadow-2xl z-40 transform transition-transform duration-300 ease-in-out lg:hidden ${
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="p-4 border-t border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900">
            <div className="text-xs text-center text-gray-500 dark:text-gray-400">
              ...
              <p className="mt-1">
                {currentTime.toLocaleTimeString("en-CA", { hour12: true })}
              </p>
            </div>
          </div>
        </div>
              ...
              <div className="grid grid-cols-1 xl:grid-cols-12 gap-6">
                ...
                <div className="xl:col-span-6 space-y-6">
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-6">
                      {showAdvancedFeatures && (
                        <PerformanceAlerts stocks={stocks} />
                      )}
