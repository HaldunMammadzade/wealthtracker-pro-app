...
import { X, Bell, TrendingUp, TrendingDown, Info, AlertTriangle, Clock, Settings, CheckCircle, XCircle } from 'lucide-react';
...
export default function NotificationsPanel({ isOpen, onClose }: NotificationsPanelProps) {
  ...
  const [filter, setFilter] = useState<'all' | 'unread' | 'price' | 'news'>('all');
          ...
          <div className="p-4 border-t border-gray-200 bg-gray-50">
            <div className="flex items-center justify-between">
              ...
              <button 
                ...
                onClick={() => {/* View all notifications page */}}
              >
                View All
              </button>
            </div>
