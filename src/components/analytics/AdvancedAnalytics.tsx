...
export default function AdvancedAnalytics({ stocks }: AdvancedAnalyticsProps) {
  const [activeMetric, setActiveMetric] = useState<'performance' | 'risk' | 'correlation' | 'attribution'>('performance');
